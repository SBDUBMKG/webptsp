...
<head>
	...
	<title>Installation | addChat V2</title>
	<!-- Required meta tags -->
	<meta charset="utf-8">
...
<div class="container">
    <div class="row">
    	<div class="offset-md-3 col-md-6">
			<div class="jumbotron">
				<h2 class="form-signin-heading text-center">addChat V2 | Installation</h2><br>
				<h5>Installation Instructions</h5>
				
				<ol type="1">
					<li>Read the addChat Requirements and Installation instructions carefully given in the documentation.</li>
	...
	<section id="step_1">
		<div class="row">
			<div class="offset-md-3 col-md-6">
				<h4>Step 1</h4>
				<p>Enter your existing database credentials to import addChat tables.</p>
			</div>
		</div>
		<div class="row">
			<div class="offset-md-3 col-md-6">
	...
	<section id="step_2">
		<div class="row">
			<div class="offset-md-3 col-md-6">
				<h4>Step 2</h4>
				<p>Enter existing 'Users' table and it's columns names to let addChat get familiar with your existing users base.</p>
			</div>
		</div>
		<div class="row">
			<div class="offset-md-3 col-md-6">
    ...
    <section id="step_3">
	    <div class="row">
			<div class="offset-md-3 col-md-6">
				<h4>Step 3</h4>
				<p>Move the addChat assets and main files into your website directory.</p>
			</div>
		</div>
		<div class="row">
			<div class="offset-md-3 col-md-6">
	...
	<section id="step_4">
		<div class="row">
			<div class="offset-md-3 col-md-6">
				<h4>Step 4</h4>
				<p>Configure the addchat_config file according to your website configuration.</p>
			</div>
		</div>
		<div class="row">
			<div class="offset-md-3 col-md-6">
...
<code data-lang="php">
  $db['default'] = array(
	...
	.
					...
					<li>
						<p>Last, just link addChat CSS and JS to your website and initiate the addChat by adding <code>&lt;div id="addchat_initiate"&gt;&lt;/div&gt;</code> and two JavaScript variables into your website's index.php file. The file in which the <code>&lt;head&gt;</code> and <code>&lt;body&gt;</code> tags exists.</p>
