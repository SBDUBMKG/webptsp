...
class Acinstaller {
    ...
    function configure_config()
    {
    	...
    	// now let's update the addchat_config file according to the website
    	$c_data 						= array();
    	...
    	// Config path
    	$source 		= $trans['source'].'addchat_config.php';
		$destination 	= $trans['destination'].'/addchat_config.php';
		...
		// Write the new addchat_config.php file
	...
	function transfer_files() 
	{
		...
		$transfer[0]['file_check'] 	= '/addchat-app.css';
		...
		$transfer[1]['file_check'] 	= '/addchat-app.js';
		...
		$transfer[5]['file_check'] 	= '/Addchat_lib.php';
		...
		$transfer[6]['file_check'] 	= '/Addchat_init.php';
		...
		$transfer[7]['file_check'] 	= '/addchat_view.php';
