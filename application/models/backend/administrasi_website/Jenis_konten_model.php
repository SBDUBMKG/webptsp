...
class Jenis_konten_model extends CI_Model
{
    var $table      = 'm_jenis_konten';
    var $pk_name    = 'id_jenis_konten';
    var $module     = '';
    ...
    public function show_datatable($column_datatable, $iDisplayStart,$iDisplayLength,$order,$sSearch){
        ...
        */
        ...
        $this->db->where($where);
        // Select Data
        $this->db->select('id_jenis_konten, jenis_konten');
