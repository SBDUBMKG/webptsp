...
class Jenis_paparan_model extends CI_Model
{
    var $table      = 'm_jenis_paparan';
    var $pk_name    = 'id_jenis_paparan';
    var $module     = '';
    ...
    public function show_datatable($column_datatable, $iDisplayStart,$iDisplayLength,$order,$sSearch){
        ...
        */
        ...
        $this->db->where($where);
        // Select Data
        $this->db->select('id_jenis_paparan, jenis_paparan');
