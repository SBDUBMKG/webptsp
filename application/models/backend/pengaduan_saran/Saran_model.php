...
class Saran_model extends CI_Model
{
    ...
    public function show_datatable($column_datatable, $iDisplayStart,$iDisplayLength,$order,$sSearch) {
        ...
        */
        ...
        // Select Data
        $this->db->select('id_saran, nama, email, waktu_saran, saran, avatar, is_response, is_publish, response');
        ...
        foreach($rResult->result_array() as $aRow)
        {
            ...
            if ( $this->is_write ) {
                $row[] .= "<center>
				<a target=\"_blank\" href='".base_url().strtolower($this->module).'/edit/'.$aRow[$this->pk_name]."'><span class='btn btn-xs btn-success'><i class='fa fa-pencil'></i> Respons</span></a>
