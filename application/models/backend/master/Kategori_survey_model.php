...
class Kategori_survey_model extends CI_Model
{
    ...
    var $pk_name    = 'id_kategori_survey';
    var $module     = '';
    ...
    public function show_datatable($column_datatable, $iDisplayStart,$iDisplayLength,$order,$sSearch){
        ...
        */
        ...
        $this->db->where($where);
        // Select Data
        $this->db->select('id_kategori_survey, kategori_survey, kategori_survey_en');
