...
class Penanggung_jawab_model extends CI_Model {
    var $table      = 'm_penanggung_jawab';
    var $pk_name    = 'id_penanggung_jawab';
    var $module     = '';
        ...
        */
        ...
        if(isset($sSearch) && !empty($sSearch['value']))
        {
            ...
            for($i=0; $i<count($aColumns); $i++)
            {
                ...
                {
                    if ( $aColumns[$i] == 'penanggung_jawab' )
        ...
        $this->db->where($where);
        // Select Data
        $this->db->select('id_penanggung_jawab, penanggung_jawab');
