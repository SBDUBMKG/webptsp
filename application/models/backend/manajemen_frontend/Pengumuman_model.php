...
class Pengumuman_model extends CI_Model
{
    ...
    public function show_datatable($column_datatable, $iDisplayStart,$iDisplayLength,$order,$sSearch){
        ...
        */
        ...
        $this->db->where($where);
        // Select Data
        $this->db->select('id_pengumuman, judul, judul_en, isi, isi_en, is_publish, expired_date');
        ...
        foreach($rResult->result_array() as $aRow)
        {
            ...
            $row[] = $aRow['judul'];
                ...
                $aktif = $aRow['is_publish'] == 1 ? '<small class="label label-success">Ya</small>' : '<small class="label label-danger">Tidak</small>';
