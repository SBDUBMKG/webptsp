...
class Sosial_media_model extends CI_Model
{
    var $table      = 'tbl_sosial_media';
    var $pk_name    = 'id';
    var $module     = '';
    ...
    public function show_datatable($column_datatable, $iDisplayStart,$iDisplayLength,$order,$sSearch){
        ...
        */
        ...
        $this->db->where($where);
        // Select Data
        $this->db->select('id, sosial_media, link, is_show');
        ...
        foreach($rResult->result_array() as $aRow)
        {
            ...
            $row[] = $aRow['sosial_media'];
            $row[] = $aRow['link'];
            $row[] = $aRow['is_show'] == 1 ? '<small class="label label-success">Ya</small>' : '<small class="label label-danger">Tidak</small>';
