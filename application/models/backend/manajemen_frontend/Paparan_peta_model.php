...
class Paparan_peta_model extends CI_Model
{
    var $table      = 'tbl_paparan_peta';
    var $pk_name    = 'id';
    var $module     = '';
    ...
    public function show_datatable($column_datatable, $iDisplayStart,$iDisplayLength,$order,$sSearch){
        ...
        */
        ...
        $this->db->where($where);
        // Select Data
        $this->db->select('id, paparan_peta, paparan_peta_en');
        ...
        foreach($rResult->result_array() as $aRow)
        {
            ...
            $row[] = $aRow['paparan_peta'];
            $row[] = $aRow['paparan_peta_en'];                
            $row[] = '';
