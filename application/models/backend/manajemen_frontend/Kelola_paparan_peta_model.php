...
class Kelola_paparan_peta_model extends CI_Model
{
    var $table      = 'tbl_paparan';
    var $pk_name    = 'id_paparan';
    var $module     = '';
    ...
    public function show_datatable($column_datatable, $iDisplayStart,$iDisplayLength,$order,$sSearch){
        ...
        */
        ...
        $this->db->where($where);
        // Select Data
        $this->db->select('id_paparan, judul, jenis_paparan, lampiran');
        $this->db->join('m_jenis_paparan', 'tbl_paparan.id_jenis_paparan=m_jenis_paparan.id_jenis_paparan', 'left');
