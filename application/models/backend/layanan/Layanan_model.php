...
class Layanan_model extends CI_Model
{
    ...
    public function show_datatable($column_datatable, $iDisplayStart,$iDisplayLength,$order,$sSearch){
        ...
        */
        ...
        $this->db->where($where);
        // Select Data
        $this->db->select('id_layanan, bidang, layanan, layanan_en, lampiran');
        ...
        foreach($rResult->result_array() as $aRow)
        {
            ...
            $row[] = $aRow['layanan'];
            $row[] = $aRow['layanan_en'];
            $row[] = empty($aRow['lampiran']) ? NULL : '<a href="'.base_url().'upload/layanan/'.$aRow['lampiran'].'"><i class="fa fa-download"> Lampiran</a>';
