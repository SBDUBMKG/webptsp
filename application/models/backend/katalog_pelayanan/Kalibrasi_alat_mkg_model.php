    ...
    foreach($rResult->result_array() as $aRow)
    {
      ...
      if( $id_role == 1 ) { // ADMIN
        ...
        if( $aRow['status'] == 0 ) {
          ...
          $stts = '<font color=green><i class="fa fa-fw fa-check"></i> Transaksi Sukses</font>';
          $aksi = '<a class="btn btn-xs btn-success" href="'.site_url('upload/pengantar/'.$aRow['pengantar']).'"><i class="fa fa-fw fa-print"></i> Hasil Layanan </a> <a class="btn btn-xs btn-danger" href="'.site_url('backend/katalog_pelayanan/informasi_mkg/review/'.$aRow[$this->pk_name]).'"><i class="fa fa-fw fa-pencil-square"></i> Review Layanan</a>';
        } else if( $aRow['status'] == 8 ) {
          ...
          $stts = '<font color=green><i class="fa fa-fw fa-check"></i> Transaksi Sukses</font>';
          $aksi = '<a class="btn btn-xs btn-success" href="'.site_url('upload/pengantar/'.$aRow['pengantar']).'"><i class="fa fa-fw fa-print"></i> Hasil Layanan </a>';
        } else {
          $stts = '<font color=red><i class="fa fa-fw fa-warning"></i> Error</font>';
          $aksi = '<font color=red><i class="fa fa-fw fa-warning"></i> Error</font>';
        }
