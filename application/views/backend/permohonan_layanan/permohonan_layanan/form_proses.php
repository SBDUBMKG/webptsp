      ...
      <div class="col-xs-12">
        <div class="box box-info">
          ...
          <div class="box-body">
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">
                    <?= $this->lang->line('form.request.type') ?>
                </label>
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">
                    <?= $this->lang->line('form.request.unit') ?>
                </label>
                <div class="col-md-9 col-sm-9 col-xs-12">
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">
                    <?= $this->lang->line('form.request.price') ?>
                </label>
                <div class="col-md-9 col-sm-9 col-xs-12">
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">
                    <?= $this->lang->line('form.request.responsible') ?>
                </label>
                <div class="col-md-9 col-sm-9 col-xs-12">
            ...
            <!-- <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">
                    <?= $this->lang->line('form.request.weight') ?>
                </label>
                <div class="col-md-9 col-sm-9 col-xs-12">
            ...
            <!-- <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">
                    <?= $this->lang->line('form.request.weight.unit') ?>
                </label>
                <div class="col-md-9 col-sm-9 col-xs-12">
          ...
          <div class="box-footer" style="text-align: center;">
              ...
              <button type="submit" class="btn btn-success" id="save_produk">
