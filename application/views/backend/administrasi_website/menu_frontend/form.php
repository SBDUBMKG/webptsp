            ...
            <div class="box box-info">
                ...
                <form class="form-horizontal" method="post">
                    <div class="box-body">
                      ...
                      <!-- Baris awal penambahan kolom translate bhs inggris oleh Nurhayati Rahayu 05/06/2024 -->
                      <div class="form-group halaman">
                         <label class="control-label col-md-3 col-sm-3 col-xs-12">Isi Halaman Indonesia <span class="required">*</span></label>
                         <div class="col-md-9 col-sm-9 col-xs-12">
                             <textarea id="rte" name="rte" rows="10" cols="80"><?php echo empty($detail['text_rte']) ? ' - ' : $detail['text_rte']; ?></textarea>
                         </div>
                      </div>
                      <div class="form-group halaman">
                         <label class="control-label col-md-3 col-sm-3 col-xs-12">Isi Halaman English <span class="required">*</span></label>
                         <div class="col-md-9 col-sm-9 col-xs-12">
                             <textarea id="rte_en" name="rte_en" rows="10" cols="80"><?php echo empty($detail['text_rte_en']) ? ' - ' : $detail['text_rte_en']; ?></textarea>
                         </div>
                      </div>
                      <!-- Baris akhir penambahan kolom translate bhs inggris oleh Nurhayati Rahayu 05/06/2024 -->
                      <div class="form-group">
...
<script type="text/javascript">
    $(function () {
        ...
        //Baris awal penambahan kolom traslate bhs inggris oleh Nurhayati Rahayu 05/05/2023
        $('#rte_en').summernote();
        //Baris akhir penambahan kolom traslate bhs inggris oleh Nurhayati Rahayu 05/05/2023
