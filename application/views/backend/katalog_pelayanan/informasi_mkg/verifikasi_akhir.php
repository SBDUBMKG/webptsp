    ...
    <div class="col-xs-12">
      ...
      <div class="box box-info">
      	<form class="form-horizontal" enctype="multipart/form-data" method="post">
            ...
            <?php if( empty($detail->pengantar) ) { ?>
            <div class="form-group">
              <div class="col-md-3">
                <label class="control-label">Unggah Dokumen Pengantar :</label>
              </div>
              <div class="col-md-9">
            ...
            <?php } ?>
              ...
              <?php if($detail_produk->ambil_di_ptsp == "Ya") {
                $check_1 = "checked";
                $check_2 = NULL;
              } else {
                $check_1 = NULL;
              ...
              ?>
		        ...
		        <div class="form-group">
		        	<div class="col-md-3">
		        		<label class="control-label">Unggah Dokumen Hasil Layanan :</label>
		        	</div>
	            <div class="col-md-9">
                <?php if( !empty($detail_produk->download) ) { ?>
                <input class="form-control" type="file" id="download" name="download"/>
                <a href="<?= site_url('upload/dokumen/'.$detail_produk->download) ?>" target="_blank">Lihat dokumen dari Back Office</a>
	          ...
	          <div class="form-group">
	            ...
	            <div class="col-md-9 col-sm-9 col-xs-12">
                  ...
                  <?= empty($detail_produk->catatan) ? '' : $detail_produk->catatan ?>
                </textarea>
	          	</div>
	          </div>
		      </div>
