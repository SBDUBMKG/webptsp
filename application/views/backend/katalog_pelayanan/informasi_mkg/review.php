...
<section class="content">
    ...
    <div class="col-xs-12">
      ...
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title"><strong>Survey Indeks Kepuasan Masyarakat (IKM) Terhadap Layanan PTSP BMKG</strong></h3>
        </div>
        <div class="box-body">
        	<?php foreach ($pertanyaan as $key => $val) { $id = $val['id_pertanyaan_survey']?>
            		...
            		<input type="radio" value="4" name="<?= $id ?>" id="<?= $id ?>" required /> Sangat Setuju
            	</label>
            	<label class="radio-inline">
            		<input type="radio" value="3" name="<?= $id ?>" id="<?= $id ?>" required /> Setuju
            	</label>
							<label class="radio-inline">
            		<input type="radio" value="2" name="<?= $id ?>" id="<?= $id ?>" required /> Kurang Setuju
            	</label>
            	<label class="radio-inline">
            		<input type="radio" value="1" name="<?= $id ?>" id="<?= $id ?>" required /> Tidak Setuju
            	</label>
						</div>
					</div>
					<hr>
