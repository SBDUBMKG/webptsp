                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="datatable">
                            ...
                            <tr>
                                ...
                                <th style="text-align: center;">Judul Ind</th>
                                <th style="text-align: center;">Judul En</th>
                                <th style="text-align: center;">Isi Ind</th>
                                <th style="text-align: center;">Isi En</th>
                                <th style="text-align: center;">Tanggal Event</th>
                                <th style="text-align: center;">Dipublikasi</th>
