...
<section class="content">
    <div class="row">
        <div class="col-xs-12">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-9 col-sm-9 col-xs-12">
                            ...
                            <input type="date" style="padding: 3px 0;" data-date-format="yyyy-mm-dd" value="<?php echo empty($detail['tanggal_berita']) || $detail['tanggal_berita'] == '0000-00-00' ? date('Y-m-d') : $detail['tanggal_berita']; ?>" name="tanggal_berita" required>
                            </div>
                           </div>
                        </div>
                        <div class="form-group">
			...
			<!-- Menghilangkan kolom Sumber. Perbaikan oleh Nurhayati Rahayu (22/10/2019)
                        <div class="form-group">
			...
			Baris terakhir perbaikan -->
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-9 col-sm-9 col-xs-12">
                              ...
                              ?>
                               <label class="radio-inline"><input type="radio" name="is_publish" value="1" <?php echo $tampilkan_menu == 1 ? 'checked' : NULL; ?>>Ya</label>
                               <label class="radio-inline"><input type="radio" name="is_publish" value="0" <?php echo $tampilkan_menu == 0 ? 'checked' : NULL; ?>>Tidak</label>
                           </div>
                        </div>
                    </div>
                    <!-- /.box-body -->
