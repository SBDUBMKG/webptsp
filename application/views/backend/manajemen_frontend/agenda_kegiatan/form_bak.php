        ...
        <div class="col-xs-12">
            ...
            <div class="box box-info">
                ...
                <form class="form-horizontal" method="post">
                   ...
                   <div class="col-md-9 col-sm-9 col-xs-12">
                       <input type="text" class="form-control" name="jam" value="<?php echo empty($detail['jam']) ? NULL : $detail['jam']; ?>" max_length="250" required>
                   </div>
                </div><div class="form-group">
                   ...
                   <div class="col-md-9 col-sm-9 col-xs-12">
                       <input type="text" class="form-control" name="foto" value="<?php echo empty($detail['foto']) ? NULL : $detail['foto']; ?>" max_length="250" required>
                   </div>
                </div><div class="form-group">
                   <label class="control-label col-md-3 col-sm-3 col-xs-12">Tgl Mulai <span class="required">*</span></label>
                   <div class="col-md-9 col-sm-9 col-xs-12">
                       <input type="text" class="form-control" name="tgl_mulai" value="<?php echo empty($detail['tgl_mulai']) ? NULL : $detail['tgl_mulai']; ?>" required>
                   </div>
                </div><div class="form-group">
                   <label class="control-label col-md-3 col-sm-3 col-xs-12">Tgl Selesai <span class="required">*</span></label>
                   <div class="col-md-9 col-sm-9 col-xs-12">
                       <input type="text" class="form-control" name="tgl_selesai" value="<?php echo empty($detail['tgl_selesai']) ? NULL : $detail['tgl_selesai']; ?>" required>
                   </div>
                </div>
                    </div>
                    <!-- /.box-body -->
