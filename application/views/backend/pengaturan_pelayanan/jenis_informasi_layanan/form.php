        ...
        <div class="col-xs-12">
            ...
            <div class="box box-info">
                ...
                <form class="form-horizontal" method="post">
                   ...
                   <div class="col-md-9 col-sm-9 col-xs-12">
                       <input type="text" class="form-control" name="jenis_informasi_layanan" value="<?php echo empty($detail['jenis_informasi_layanan']) ? NULL : $detail['jenis_informasi_layanan']; ?>" max_length="50">
                   </div>
                </div><div class="form-group">
