      ...
      <div class="container">
        <div class="beranda-top">
          <ul>
            ...
            <li class="me-3"><a class="text-dark fw-bold" href="<?= base_url().'berita/ptsp'; ?>"><?= $bahasa == "" ? "Berita" : "News" ?></a></li>
            <li class="text-secondary"><?= $bahasa == "" ? "Detil" : "Detail" ?></li>
          </ul>
        </div>
        <div class="beranda-main">
          <div class="beranda-main-item mw-100">
            <h3><?php echo $detil_berita['judul'.$bahasa];?></h3>
          ...
          <div class="row mt-3 p-3" style="background-color: #D9EBE1; border-radius: 30px;">
            ...
            <section class="content">
                <span class="text-primary"><i class="fa fa-calendar text-primary me-2"></i><?php echo format_datetime($detil_berita['tanggal_berita']);?></span>
                <div class="single_page_content">
                  <img class="img-fluid mt-2" style="" src="<?php echo base_url();?>upload/thumbnail/<?php echo $detil_berita['thumbnail'];?>" alt="">
