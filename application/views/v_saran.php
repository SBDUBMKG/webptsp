...
<div class="beranda-area">
			<div class="container">
				<div class="beranda-top">
					...
					<li class="text-secondary"><?php echo $bahasa == "" ? "Saran" : "Suggestions" ?></li>
					</ul>
				</div>
				<div class="beranda-main">
					<div class="beranda-main-item">
						<h3><?php echo $bahasa == "" ? "Saran" : "Suggestions" ?></h3>
              ...
              <section class="content">
                      ...
                      <div class="box box-default">
                        <div class="box-header">
                          <h6><?php echo $total_saran ?> <?php echo translate(31);?></h6>
                          ...
                          <div class="beranda-item beranda-item1 mt-3 pt-4">
                            <div class="row">
                              <div class="col text-start">
                                ...
                                <p><?php echo translate(15);?> : <?php echo $value['waktu_saran'] ?></p>
                              </div>
