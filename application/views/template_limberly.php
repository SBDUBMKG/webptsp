...
<head>
  ...
  ?>
	...
	<script type="text/javascript" src="<?= site_url('resources/plugins/jQuery/jquery-3.7.1.min.js') ?>"></script>
				...
				<div class="modal-body">
					...
					<div class="row">
                        <div class="col-xs-6">
                            ...
                            <br>
                            <br>
                            <input type="text" name="txt_captcha" id="txt_captcha" class="form-control" placeholder="Captcha"  >
                        </div
                    </div>
				</div>
