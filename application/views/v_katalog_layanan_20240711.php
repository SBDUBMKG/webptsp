      ...
      <div class="panel-group" id="accordion">
        <div class="panel panel-default">
          <div class="panel-heading">
            <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapse1"><?= $detail_layanan['layanan'.$bahasa] ?></a></h4>
          </div>
                  ...
                  <div class="group center">
                    ...
                    <article class="one_quarter<?php if($i == 0 || $i % 4 == 0){ echo " first"; } ?>" style="margin-bottom:10px; border:solid 2px #42a5f5;padding:3px">
                      ...
                      <a href="<?= site_url('katalog_pelayanan/detail_layanan/'.$value['id_layanan']) ?>">
                        <i class="icon" style="font-size: 0px;margin-bottom:5px">
                      ...
                      <div style="height:170px">
                        <h4 class="font-x1">
                          ...
                          <div class="center">
                              <!-- <?php if (!empty($value['contoh'])) { ?>
                                <a target="_blank" class="btn btn-primary btn-sm" href="<?php echo base_url()."upload/dokumen/".$value['contoh']?>"><i class="fa fa-info-circle"></i> <?php echo translate('txt_contoh_layanan',true);?></a>
                              <?php } ?> -->
...
// line 42 : mengubah margin-bottom:30px menjadi margin-bottom:20px. Perubahan dilakukan oleh : Nurhayati Rahayu (14/10/2019)					
// line 57 : mengubah height:76px menjadi height:170px. Perubahan dilakukan oleh : Nurhayati Rahayu (14/10/2019)
