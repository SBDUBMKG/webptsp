			...
			<div class="container">
				<div class="beranda-top">
					<ul>
						...
						<li class="text-secondary"><?php echo translate(113);?></li>
					</ul>
				</div>
				<div class="beranda-main">
					...
					<div class="row mt-3">
						<div class="col d-flex mb-mobile">
							<div class="btn-katalog-green me-2">
					...
					<div class="row mt-4" style="background-color: #D9EBE1; border-radius: 30px;">
					<?php foreach ($layanan as $key => $value) { ?>
						<div class="col-md-4 col-lg-4">
							<div class="beranda-item beranda-item1 mx-2" style="margin-top: 85px; margin-bottom: 40px;">
