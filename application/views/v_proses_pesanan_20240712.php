    ...
    <div class="content"> 
      ...
      <table style="border:0">
        ...
        <tr>
          ...
          <td width="5%" style="border:0">:</td>
          <td style="border:0"><?= empty($value['options']['harga']) ? ' - ' : 'Rp. '.number_format($value['options']['harga'],0,',','.'); ?></td>
        </tr>
        <tr>
      ...
      <span><em>Perhatian : </em></span><br><br>
      <span><em>Untuk proses selanjutnya, Anda HARUS untuk menyiapkan dokumen permohonan layanan dalam bentuk file PDF yang berisi : </em></span><br>
      <!-- <span><em>* KTP </em></span><br> -->
      <span><em>* Surat permohononan permintaan data</em></span><br>
      <span><em>* Surat tugas</em></span><br><br>
      <a class="btn btn-sm btn-primary" href="<?= base_url().'upload/Format_surat_permohonan.zip';?>">Format Surat bermohonan</a> <br><br>
      <span><em>Bagi pelanggan yang melakukan permohonan PELAYANAN JASA KALIBRASI ALAT MKG, setelah mengunggah dokumen permohonan layanan, dalam kurun waktu maksimal 2 x 24 jam WAJIB datang ke kantor PTSP dengan membawa alat untuk dilakukan pengecekan. </em></span><br><br>
