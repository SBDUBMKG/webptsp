...
<div class="Login-form-area">
    <div class="container">
        <div class="Login-box">
            ...
            <div class="Login-pen">
                <h3><?php echo !empty($bahasa) ? 'CUSTOMER LOGIN' : 'LOGIN PELANGGAN'; ?></h3>
                <div id="langChange">
                  <form action="">
                    <input type="radio" name="l" id="toAr" <?= $bahasa == '' ? 'checked' : ''?> />
                    <a href="<?= base_url().'home/ganti_bahasa/' ?>" for="toAr" onclick="document.getElementById('lang-cnt').lang = 'ar'; document.getElementById('lang-cnt').dir = 'rtl'; "></a>
                    <input type="radio" name="l" id="toEn" <?= $bahasa == '_en' ? 'checked' : ''?> />
                    <a href="<?= base_url().'home/ganti_bahasa/_en' ?>" for="toEn" onclick="document.getElementById('lang-cnt').lang = 'en'; document.getElementById('lang-cnt').dir = 'ltr'; " ></a>
                  </form>
                </div>
            </div>
        ...
        <form method="post" action="login">
            <div style="position:relative;padding:0;margin:0;">
                ...
                <img src="<?php echo base_url().'resources/themes/frontend_ptsp/images/form-logo.png'?>" style="position:absolute;bottom:12px;left:15px;width:20px;height:20px;">
            </div>
            <div style="position:relative;padding:0;margin:0;">
                ...
                <img src="<?php echo base_url().'resources/themes/frontend_ptsp/images/formp.png'?>" style="position:absolute;bottom:12px;left:15px;width:20px;height:20px;">
            </div>
            <div class="login-lupa">
                <a href="<?php echo base_url().'home/forget_pass/';?>"> <?php echo translate('lupa_password',true);?></a>
            </div>
            ...
            <div class="login-btn">
                <button type="submit" class="text-white"><?php echo !empty($bahasa) ? 'Login' : 'Masuk'; ?></button>
            </div>
            <div class="login-or">
            ...
            <div class="login-dafter">
                ...
                <button><a class="text-white" href="<?php echo base_url().'registrasi';?>"> <?php echo !empty($bahasa) ? 'Registration' : 'Daftar'; ?> </a></button>
                </div>
                <div class="dafter-right">
                <button><a class="text-white" href="<?php echo base_url();?>"> <?php echo !empty($bahasa) ? 'Home' : 'Beranda'; ?> </a></button>
                </div>
            </div>
        </form>
        </div>
