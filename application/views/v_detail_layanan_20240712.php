  ...
  <main class="hoc container clear"> 
    ...
    <div class="content">
      ...
      <table style="border:0">
        ...
        <tr>
          <td width="20%" style="border:0"><ul><li>Contoh</li></ul></td>
          <td width="5%" style="border:0">:</td>
          <td style="border:0">

                <?php if(!empty($detail_layanan['contoh'])){?><a href="<?php echo base_url()."upload/dokumen/".$detail_layanan['contoh'] ?>" target="_blank" ><img src="<?php echo base_url()."upload/dokumen/".$detail_layanan['contoh'] ?>" class="img-responsive" width=200></a>
              <?php }else{ ?>

            <!-- <img src="https://via.placeholder.com/200" class="img-responsive"></td> -->
          <?php } ?>
        </tr>
      </table>
      <hr>
