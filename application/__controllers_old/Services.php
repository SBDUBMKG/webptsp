...
class Services extends CI_Controller {
    ...
    public function get_detail_layanan() {
        ...
        // append form
        $addform = '<div id="content_form"><h4 class="box-title">Rincian Produk</h4><hr>';
        $display_coloumn = json_decode($list_layanan->display_coloumn, true);
            ...
            // format text
                ...
                $addform .= '
                        <div class="form-group" id="addform">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">'.$value.' * </label>
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <input type="text" class="form-control" name="'.$key.'" id="'.$key.'" max_length="100" required>
                            </div>
                        </div>
                ';                
            }
