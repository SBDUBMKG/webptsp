    ...
    public function validasi_pesanan()
    {
        ...
        if (!empty($id_role) && !empty($username)) {
            ...
            if (!empty($data) && !empty($id_admin)) {
                ...
                $insert        = $this->global_model->insert_data('tbl_permohonan', $data_insert);
                ...
                $this->cart->destroy();
                // redirect(site_url('backend/katalog_pelayanan/informasi_mkg/proses/' . $id_permohonan));
                redirect(site_url('backend/permohonan_layanan/permohonan_layanan/proses/' . $id_permohonan));
                die();
            } else {
                // jika cart kosong
