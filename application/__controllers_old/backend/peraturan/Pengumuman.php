...
"processing": true,
        ...
        $this->template->write_view('content', $this->folder.'/pengumuman/datatable', $data, true);
    ...
    function add() {
        ...
        $this->template->write_view('content', $this->folder.'/pengumuman/form', $data, true);
        $this->template->render();
    }
    function edit($id = 0) {
        $this->load->model('global_model');
