 ...
 */
class Visimisi_tupoksi extends MY_Controller {
    var $page_title = 'Kelola Visi Misi';
    var $column_datatable = array('id', 'value', 'value','id_jenis');
    ...
    function __construct(){
        ...
        $this->load->model($this->folder.'/'.'visimisi_tupoksi_model', 'app_model');
    ...
    public function index()
    {
        ...
        $this->template->write_view('content', $this->folder.'/visimisi_tupoksi/datatable', $data, true);
    ...
    function edit($id = 0) {
        ...
        if($_POST)
        {
            ...
            if ( $simpan ) {
                ...
                if ( $update ) {					insert_log('Edit visi misi');
        ...
        $this->template->write_view('content', $this->folder.'/visimisi_tupoksi/form', $data, true);
        $this->template->render();
    }
}
