...
class Pengaduan_saran extends MY_Controller {
    var $page_title       = 'Pengaduan Saran';
    ...
    function __construct(){
        ...
        $this->load->model($this->folder.'/'.'pengaduan_saran_model', 'app_model');
...
"processing": true,
        ...
        $this->template->write_view('content', $this->folder.'/pengaduan_saran', $data, true);
