...
class Layanan extends MY_Controller {
    var $page_title = 'Data Layanan';
    var $column_datatable = array('id_layanan', 'bidang','layanan','layanan_en','lampiran');
    ...
    function add() {
        ...
        if($_POST)
        {
            ...
            if ( $simpan ) {
                ...
                }				if ( $simpan ) {					$insert = $this->app_model->insert_data($data_insert);					if ( $insert ) {						redirect(base_url().$module);					} else {						$errMsg = 'Data gagal disimpan';					}				}
            }
        }
