...
class Satuan extends MY_Controller {
    var $page_title = 'satuan';
    var $column_datatable = array('id_satuan', 'satuan');
    ...
    function __construct(){
        ...
        $this->load->model($this->folder.'/'.'satuan_model', 'app_model');
...
"processing": true,
        ...
        $this->template->write_view('content', $this->folder.'/satuan/datatable', $data, true);
    ...
    function add() {
        ...
        $this->template->write_view('content', $this->folder.'/satuan/form', $data, true);
        $this->template->render();
    }
    function edit($id = 0) {
        $this->load->model('global_model');
        ...
        if($_POST)
        {
            ...
            if ( $simpan ) {
                $data_update = array(    'satuan' => strip_tags($this->input->post('satuan')),
            );
