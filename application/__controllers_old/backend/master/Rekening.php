...
class Rekening extends MY_Controller {
    var $page_title = 'Rekening';
    var $column_datatable = array('id_rekening', 'nama','no_rek','aktif');
...
"processing": true,
        ...
        $this->template->write_view('content', $this->folder.'/rekening/datatable', $data, true);
    ...
    function add() {
        ...
        if($_POST)
        {
            ...
            'nama' => strip_tags($this->input->post('nama')),
                ...
                'aktif' => strip_tags($this->input->post('aktif')),
            );
        ...
        $this->template->write_view('content', $this->folder.'/rekening/form', $data, true);
        $this->template->render();
    }
    function edit($id = 0) {
        $this->load->model('global_model');
