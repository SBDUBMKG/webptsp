...
class Kelurahan extends MY_Controller {
    var $page_title = 'Kelurahan';
    var $column_datatable = array('id_kelurahan', 'provinsi' ,'kabkot' ,'kecamatan','kelurahan','kode_pos');
    ...
    function __construct(){
        ...
        $this->load->model($this->folder.'/'.'kelurahan_model', 'app_model');
...
"processing": true,
        ...
        $this->template->write_view('content', $this->folder.'/kelurahan/datatable', $data, true);
    ...
    function add() {
        ...
        $this->template->write_view('content', $this->folder.'/kelurahan/form', $data, true);
        $this->template->render();
    }
    function edit($id = 0) {
        $this->load->model('global_model');
