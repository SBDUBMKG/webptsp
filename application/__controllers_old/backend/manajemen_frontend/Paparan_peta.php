 ...
 */
class Paparan_peta extends MY_Controller {
    var $page_title = 'Kelola Paparan Peta';
    var $column_datatable = array('id', 'paparan_peta','paparan_peta_en');
...
"processing": true,
    ...
    private function valid_form($act = 'add') {
        ...
        $config = array(
                    ...
                    array(
                        'field' => 'paparan_peta_en',
                        'label' => 'Paparan Peta En',
                        'rules' => 'required'
                    ),
                );
    ...
    function edit($id = 0) {
        ...
        if($_POST)
        {
            ...
            if ( $simpan ) {
                $data_update = array(    
                    'paparan_peta' => $this->input->post('paparan_peta'),
                    'paparan_peta_en' => $this->input->post('paparan_peta_en'),
                );
