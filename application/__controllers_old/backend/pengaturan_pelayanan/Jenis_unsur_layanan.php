 ...
 */
class Jenis_unsur_layanan extends MY_Controller {
    var $page_title = 'Jenis Unsur Layanan';
    var $column_datatable = array('id_jenis_unsur_layanan', 'jenis_layanan','jenis_permintaan_layanan','jenis_unsur_layanan','back_office','keterangan','aktivasi');
    ...
    function __construct(){
        ...
        $this->load->model($this->folder.'/'.'jenis_unsur_layanan_model', 'app_model');
...
"processing": true,
        ...
        $this->template->write_view('content', $this->folder.'/jenis_unsur_layanan/datatable', $data, true);
    ...
    private function valid_form($act = 'add') {
        ...
        $config = array(
                    array(
                        'field' => 'jenis_unsur_layanan',
                        'label' => 'Jenis Unsur Layanan',
                        'rules' => 'max_length[50]'
                    ),
    ...
    function add() {
        ...
        if($_POST)
        {
            ...
            'id_jenis_layanan' => $this->input->post('id_jenis_layanan'),
                ...
                'jenis_unsur_layanan' => strip_tags($this->input->post('jenis_unsur_layanan')),
                'id_back_office' => $this->input->post('id_back_office'),
        ...
        $this->template->write_view('content', $this->folder.'/jenis_unsur_layanan/form', $data, true);
        $this->template->render();
    }
    function edit($id = 0) {
        $this->load->model('global_model');
        ...
        if($_POST)
        {
            ...
            if ( $simpan ) {
                $data_update = array(    'id_jenis_layanan' => $this->input->post('id_jenis_layanan'),
                'id_jenis_permintaan_layanan' => $this->input->post('id_jenis_permintaan_layanan'),
                'jenis_unsur_layanan' => strip_tags($this->input->post('jenis_unsur_layanan')),
                'id_back_office' => $this->input->post('id_back_office'),
                'keterangan' => $this->input->post('keterangan'),
