 ...
 */
class Jenis_detail_informasi_layanan extends MY_Controller {
    var $page_title = 'Jenis Detail Informasi Layanan';
    var $column_datatable = array('id_jenis_detail_informasi_layanan', 'jenis_layanan', 'jenis_permintaan_layanan','jenis_unsur_layanan','jenis_informasi_layanan','jenis_detail_informasi_layanan','keterangan','aktivasi');
    ...
    function __construct(){
        ...
        $this->load->model($this->folder.'/'.'jenis_detail_informasi_layanan_model', 'app_model');
...
"processing": true,
        ...
        $this->template->write_view('content', $this->folder.'/jenis_detail_informasi_layanan/datatable', $data, true);
    ...
    private function valid_form($act = 'add') {
        ...
        $config = array(
                    array(
                        'field' => 'jenis_detail_informasi_layanan',
                        'label' => 'Jenis Detail Informasi Layanan',
                        'rules' => 'max_length[50]'
                    ),
    ...
    function add() {
        ...
        if($_POST)
        {
            ...
            if ( $simpan ) {
                ...
                'id_jenis_permintaan_layanan' => $this->input->post('id_jenis_permintaan_layanan'),
                'id_jenis_unsur_layanan' => $this->input->post('id_jenis_unsur_layanan'),
                'id_jenis_informasi_layanan' => $this->input->post('id_jenis_informasi_layanan'),
                'jenis_detail_informasi_layanan' => strip_tags($this->input->post('jenis_detail_informasi_layanan')),
        ...
        $this->template->write_view('content', $this->folder.'/jenis_detail_informasi_layanan/form', $data, true);
        $this->template->render();
    }
    function edit($id = 0) {
        $this->load->model('global_model');
