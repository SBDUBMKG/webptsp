 ...
 */
class Log_user extends MY_Controller {
    var $page_title = 'Log User';
    var $column_datatable = array('id', 'proses','username','created');
    ...
    function __construct(){
		...
		$this->load->helper('general_helper'); // Script yang ditambahkan Rahmat, 23 September 2020
        $this->load->model($this->folder.'/'.'log_user_model', 'app_model');
        ...
        $script = '
            ...
            $(function () {
                var oTable = $("#datatable").DataTable({
                    ...
                    "order": [[ 0, "desc" ]],
                    "lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]], // Script yang ditambahkan Rahmat, 23 September 2020
"processing": true,
                    "serverSide": true,
                    "responsive": true,
                    "ajax" : {
        ...
        $this->template->write_view('content', $this->folder.'/log_user/datatable', $data, true);
    ...
    function add() {
        ...
        $this->template->write_view('content', $this->folder.'/log_user/form', $data, true);
        $this->template->render();
    }
    function edit($id = 0) {
        $this->load->model('global_model');
