...
class Jenis_layanan extends MY_Controller {
    var $page_title       = 'Jenis Layanan';
    var $column_datatable = array('id_jenis_layanan', 'jenis_layanan','keterangan','aktivasi');
    ...
    function __construct(){
        ...
        $this->load->model($this->folder.'/'.'jenis_layanan_model', 'app_model');
    ...
    public function index() {
        ...
        $this->template->write_view('content', $this->folder.'/jenis_layanan/datatable', $data, true);
    ...
    function add() {
        ...
        if($_POST) {
            ...
            if ( $simpan ) {
                $data_insert = array(
                    'jenis_layanan' => strip_tags($this->input->post('jenis_layanan')),
        ...
        $this->template->write_view('content', $this->folder.'/jenis_layanan/form', $data, true);
        $this->template->render();
    }
