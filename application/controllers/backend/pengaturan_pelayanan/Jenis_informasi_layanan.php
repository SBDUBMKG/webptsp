 ...
 */
class Jenis_informasi_layanan extends MY_Controller {
    var $page_title = 'Jenis Informasi Layanan';
    var $column_datatable = array('jenis_layanan', 'id_jenis_informasi_layanan', 'jenis_permintaan_layanan','jenis_unsur_layanan','jenis_informasi_layanan','keterangan','aktivasi');
    ...
    function __construct(){
        ...
        $this->load->model($this->folder.'/'.'jenis_informasi_layanan_model', 'app_model');
...
"processing": true,
        ...
        $this->template->write_view('content', $this->folder.'/jenis_informasi_layanan/datatable', $data, true);
    ...
    private function valid_form($act = 'add') {
        ...
        $config = array(
                    array(
                        'field' => 'jenis_informasi_layanan',
                        'label' => 'Jenis Informasi Layanan',
                        'rules' => 'max_length[50]'
                    ),
    ...
    function add() {
        ...
        if($_POST)
        {
            ...
            if ( $simpan ) {
                ...
                'jenis_informasi_layanan' => strip_tags($this->input->post('jenis_informasi_layanan')),
        ...
        $this->template->write_view('content', $this->folder.'/jenis_informasi_layanan/form', $data, true);
        $this->template->render();
    }
