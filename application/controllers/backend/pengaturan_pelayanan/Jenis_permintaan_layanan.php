...
class Jenis_permintaan_layanan extends MY_Controller {
    var $page_title = 'Jenis Permintaan Layanan';
    ...
    function __construct(){
        ...
        $this->load->model($this->folder.'/'.'jenis_permintaan_layanan_model', 'app_model');
...
"processing": true,
        ...
        $this->template->write_view('content', $this->folder.'/jenis_permintaan_layanan/datatable', $data, true);
    ...
    private function valid_form($act = 'add') {
        ...
        $config = array(
                    array(
                        'field' => 'jenis_permintaan_layanan',
                        'label' => 'Jenis Permintaan Layanan',
                        'rules' => 'max_length[50]'
                    ),
    ...
    function add() {
        ...
        if($_POST)
        {
            ...
            'id_jenis_layanan' => $this->input->post('id_jenis_layanan'),
                'jenis_permintaan_layanan' => strip_tags($this->input->post('jenis_permintaan_layanan')),
        ...
        $this->template->write_view('content', $this->folder.'/jenis_permintaan_layanan/form', $data, true);
        $this->template->render();
    }
    function edit($id = 0) {
        $this->load->model('global_model');
