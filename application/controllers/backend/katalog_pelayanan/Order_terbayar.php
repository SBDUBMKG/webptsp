...
class Order_terbayar extends MY_Controller {
  public $page_title          = 'Order Terbayar';
  // Awal script yang diedit Rahmat, 3 Juni 2020, => asalnya "E.nama" dirubah menjadi "E.perusahaan"
  public $column_datatable    = ['B.id_permohonan', 'no_permohonan', 'layanan', 'tanggal_permohonan', 'tanggal_verifikasibendahara', 'nama', 'E.perusahaan', 'B.status','no_hp'];
  // Akhir script yang diedit Rahmat, 3 Juni 2020
  //public $column_datatable2   = ['B.id_permohonan', 'no_permohonan', 'layanan', 'tanggal_permohonan', 'nama', 'E.nama', 'no_hp'];
  ...
  public function __construct()
  {
    ...
    $this->load->model($this->folder . '/' . 'order_terbayar_model', 'app_model');
  ...
  public function index()
  {
    ...
    $this->template->write_view('content', $this->folder . '/order_terbayar/datatable', $data, true);
  ...
  public function add()
  {
    ...
    $this->template->write_view('content', $this->folder . '/order_terbayar/form', $data, true);
    $this->template->render();
  }
  ...
  public function proses($id = 0)
  {
    ...
    $this->template->write('title', 'Tambah ' . $this->page_title);
    $this->template->write_view('content', $this->folder . '/order_terbayar/form_proses', $data, true);
    $this->template->render();
  }
  ...
  public function upload_permohonan($id = '')
  {
    ...
    $this->template->write_view('content', $this->folder . '/order_terbayar/upload_permohonan', $data, true);
    $this->template->render();
  }
  ...
  public function detail($id = 0)
  {
    ...
    $data['errMsg']     = $errMsg;
    $this->template->write('title', $this->page_title);
    $this->template->write_view('content', $this->folder . '/order_terbayar/preview', $data, true);
    $this->template->render();
  }
  ...
  public function invoice($id = 0)
  {
    ...
    $this->template->write_view('content', $this->folder . '/order_terbayar/invoice', $data, true);
    $this->template->render();
  }
  ...
  public function konfirmasi($id = '')
  {
    ...
    $this->template->add_js('resources/plugins/select2/select2.min.js');
    $this->template->write('title', $this->page_title);
    $this->template->write_view('content', $this->folder . '/order_terbayar/konfirmasi', $data, true);
    $this->template->render();
  }
  ...
  public function upload($id = '')
  {
    ...
    $this->template->write('title', $this->page_title);
    $this->template->write_view('content', $this->folder . '/order_terbayar/upload', $data, true);
    $this->template->render();
  }
  ...
  public function verifikasi_pembayaran($id = '')
  {
    ...
    $this->template->write('title', $this->page_title);
    $this->template->write_view('content', $this->folder . '/order_terbayar/verifikasi_pembayaran', $data, true);
    $this->template->render();
  }
  ...
  public function verifikasi($id = '')
  {
    ...
    $this->template->write('title', $this->page_title);
    $this->template->write_view('content', $this->folder . '/order_terbayar/verifikasi', $data, true);
    $this->template->render();
  }
  ...
  public function verifikasi_akhir($id = '')
  {
    ...
    $this->template->write('title', $this->page_title);
    $this->template->write_view('content', $this->folder . '/order_terbayar/verifikasi_akhir', $data, true);
    $this->template->render();
  }
  ...
  public function review($id = '')
  {
    ...
    $this->template->add_js('resources/plugins/select2/select2.min.js');
    $this->template->write('title', $this->page_title);
    $this->template->write_view('content', $this->folder . '/order_terbayar/review', $data, true);
    $this->template->render();
  }
