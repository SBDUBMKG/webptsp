...
class Kategori_survey extends MY_Controller {
    var $page_title = 'Kategori Survey';
    var $column_datatable = array('id_kategori_survey', 'kategori_survey', 'kategori_survey_en');
    ...
    function __construct(){
        ...
        $this->load->model($this->folder.'/'.'kategori_survey_model', 'app_model');
    ...
    public function index()
    {
        ...
        $this->template->write_view('content', $this->folder.'/kategori_survey/datatable', $data, true);
    ...
    function add() {
        ...
        if($_POST)
        {
            ...
            if ( $simpan ) {
                $data_insert = array(
                    'kategori_survey' => strip_tags($this->input->post('kategori_survey')),
                    'kategori_survey_en' => strip_tags($this->input->post('kategori_survey_en')),
                );
        ...
        $this->template->write_view('content', $this->folder.'/kategori_survey/form', $data, true);
        $this->template->render();
    }
    function edit($id = 0) {
        $this->load->model('global_model');
