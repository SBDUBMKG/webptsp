...
class Menu_frontend extends MY_Controller {
    ...
    var $column_datatable = array('A.id', 'kategori_menu','menu','menu_en','cname','uri','nama_file','urutan','lampiran');
...
"processing": true,
    ...
    function add() {
        ...
        $this->template->add_js('resources/plugins/ckeditor/ckeditor.js');
    ...
    function edit($id = 0) {
        ...
        $new_rte_id = $data['detail']['id_kategori_menu'] == 2 ? $data['detail']['rte'] : NULL;
        $data['new_rte_id'] = $new_rte_id;
