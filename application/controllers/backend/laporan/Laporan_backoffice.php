...
class Laporan_backoffice extends MY_Controller {
    ...
    function __construct(){
        ...
        $this->load->model($this->folder.'/'.'laporan_backoffice_model', 'app_model');
    ...
    public function index(){
        ...
        $data['jenis_layanan_selected'] =  empty($this->input->post("id_jenis_layanan")) ? NULL : $this->input->post("id_jenis_layanan");
        $data['backoffice'] = $this->global_model->get_list_array('tbl_role','id_role>=11');
        $data['backoffice_selected'] = empty($this->input->post("id_role")) ? NULL : $this->input->post("id_role");
        $data['tahun'] = empty($this->input->post("tahun")) ? date("Y") : $this->input->post("tahun");
        ...
        $judul_grafik = 'Laporan Kinerja Back Office '. ($backoffice->role ?? '') .' Tahun '.$data['tahun'];
        $judul_x = 'Bulan';
        ...
        $this->template->write_view('content', $this->folder.'/laporan_backoffice/datatable', $data, true);
