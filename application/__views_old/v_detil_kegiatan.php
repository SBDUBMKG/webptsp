    ...
    <ul class="photograph_nav  wow fadeInDown animated" style="visibility: visible; animation-name: fadeInDown;">
      ...
      <li>
        <div class="photo_grid">
          <figure class="effect-layla"> <a class="fancybox-buttons" data-fancybox-group="button" href="<?php echo base_url()."upload/kegiatan/".$value['bidang']."/".$value['nama'];?>" title="<?php echo $value['judul'.$bahasa];?>"> <img src="<?php echo base_url()."upload/kegiatan/".$value['bidang']."/".$value['nama'];?>" alt=""></a> </figure>
        </div>
      </li>
      <?php    
        }
