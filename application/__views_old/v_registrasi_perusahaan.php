              ...
              <form method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="form-group col-xs-3" id="fg_ktp">
                      ...
                      <input type="number" name="no_ktp" id="no_ktp" value="<?= empty($detail['no_ktp']) ? NULL : $detail['no_ktp']; ?>" class="form-control" required>
                  ...
                  <div class="row">
                    <div class="form-group col-xs-3">
                      <label><?= translate(47) ?> *</label>
                      <input type="text" name="tempat_lahir" value="<?= empty($detail['tempat_lahir']) ? NULL : $detail['tempat_lahir']; ?>" class="form-control" required>
                    </div>
                    <div class="form-group col-xs-3">
                      <label>Tanggal Lahir *</label>
                      <div class="input-group date">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                        <input type="text" name="tanggal_lahir" value="<?= empty($detail['tanggal_lahir']) ? NULL : $detail['tanggal_lahir']; ?>" class="form-control pull-right" id="datepicker" required>
                      </div>
                    </div>
                    <div class="form-group col-xs-4">
                      <label><?= translate(49) ?> *</label>
                      <div class="radio">
                        <label><input type="radio" name="jenis_kelamin" value="1" <?php if(isset($detail['jenis_kelamin'])){if($detail['jenis_kelamin'] == 1){echo "checked";}}?> ><?= translate(50) ?></label>
                        <label><input type="radio" name="jenis_kelamin" value="0" <?php if(isset($detail['jenis_kelamin'])){if($detail['jenis_kelamin'] == 0){echo "checked";}}?> ><?= translate(51) ?></label>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="form-group col-xs-3">
                      <label>Email *</label>
                      <input type="email" name="email" id="email" value="<?= empty($detail['email']) ? NULL : $detail['email']; ?>" class="form-control" required>
                    ...
                    <div class="form-group col-xs-3" id="fg_no_telepon">
                      <label><?= translate(57) ?></label>
                      <input type="text" id="no_telepon" name="no_telepon" value="<?= empty($detail['no_telepon']) ? NULL : $detail['no_telepon']; ?>" class="form-control numeric">
                  ...
                  <div class="row">
                    <div class="form-group col-xs-3">
                      <label><?= translate(56) ?> *</label>
                      <select class="form-control" id="kecamatan_perusahaan" name="kecamatan_perusahaan" required></select>
                    </div>

                    <div class="form-group col-xs-3">
                      <label>Kelurahan *</label>
                      <select class="form-control" id="kelurahan_perusahaan" name="kelurahan_perusahaan" required></select>
                    </div>

                    <div class="form-group col-xs-3">
                      <label>Kode Pos *</label>
                      <input class="form-control" type="text" id="kode_pos_perusahaan" name="kode_pos_perusahaan" readonly>
                    </div>
                  </div>
                  <div class="row">
                    <div class="form-group col-xs-3" id="fg_no_telepon_perusahaan">
                      <label><?= translate(57) ?></label>
                      <input type="text" name="no_telepon_perusahaan" id="no_telepon_perusahaan" value="<?= empty($detail['no_telepon_perusahaan']) ? NULL : $detail['no_telepon_perusahaan']; ?>" class="form-control numeric" required>
                      <span class="help-block" id="label_no_telepon_perusahaan"></span>
                    </div>
                    <div class="form-group col-xs-3">
                      <label>Fax</label>
                      <input type="number" name="fax" value="<?= empty($detail['fax']) ? NULL : $detail['fax']; ?>" class="form-control">
                    </div>
                  </div>
                  <div class="row">
                    <div class="form-group col-xs-3" id="fg_email_perusahaan">
                      <label>Email *</label>
                  ...
                  <a href="<?= base_url().'backend/login' ?>" style="color: black;"><?= translate(65) ?></a>
                  <br>
