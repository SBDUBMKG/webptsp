        ...
        <div class="col-xs-12">
            ...
            <div class="box box-info">
                ...
                <form class="form-horizontal" method="post">
                   ...
                   <div class="col-md-9 col-sm-9 col-xs-12">
                       <input type="text" class="form-control" name="jenis_unsur_layanan" value="<?php echo empty($detail['jenis_unsur_layanan']) ? NULL : $detail['jenis_unsur_layanan']; ?>" max_length="50">
                   </div>
                </div><div class="form-group">
                   <label class="control-label col-md-3 col-sm-3 col-xs-12">Back Office</label>
                   <div class="col-md-9 col-sm-9 col-xs-12">
                       <select class="form-control cmb_select2" id="id_back_office" name="id_back_office" >
                       <option value=""> - Pilih Back Office - </option>
                       <?php
                       $list_back_office = $this->global_model->get_list('m_back_office');
                       foreach ( $list_back_office as $back_office ) {
                           $selected = $back_office->id_back_office == (empty($detail['id_back_office']) ? NULL : $detail['id_back_office']) ? 'selected' : NULL;
                           ?>
                           <option value="<?php echo $back_office->id_back_office; ?>" <?php echo $selected; ?>><?php echo $back_office->back_office; ?></option>
                           <?php
                       }
                                        ?>       </select>
                   </div>
