            ...
            <div class="form-group">
              ...
              <div class="col-md-9 col-sm-9 col-xs-12">
                <select class="form-control cmb_select2" id="id_layanan" name="id_layanan" onchange="get_detail_layanan(this.value);check_id_layanan();">
                  <option value=""> - Pilih Jenis Jasa Kalibrasi Alat MKG -</option>
                  <?php
                  $list_layanan = $this->global_model->get_list('m_layanan', 'id_jenis_layanan = 2 AND is_produk = 1');
  ...
  $(document).ready(function () {
    ...
    $('#add_produk').click(function() {
      ...
      var content = '' +
        ...
        '<input type="hidden" name="arr_harga[]" value="'+ harga +'">'+
        '</tr>';
