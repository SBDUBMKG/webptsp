            ...
            <div class="box box-info">
                ...
                <form class="form-horizontal" method="post">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                           <label class="control-label col-md-3 col-sm-3 col-xs-12">pengaduan</label>
                           <div class="col-md-9 col-sm-9 col-xs-12">
                               <textarea class="textarea" name="pengaduan" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" disabled><?php echo empty($detail['pengaduan']) ? NULL : $detail['pengaduan']; ?></textarea>
                           </div>
                        </div>

                        <h4 class="box-title">Tanggapi Pengaduan</h4>
                        <hr>
                        <div class="form-group">
