                ...
                <form class="form-horizontal" method="post">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-9 col-sm-9 col-xs-12">
                               <input type="text" class="form-control" name="telepon_upt" value="<?php echo empty($detail['telepon_upt']) ? NULL : $detail['telepon_upt']; ?>" max_length="20">
                           </div>
                        </div>
                        <div class="form-group">
                           <label class="control-label col-md-3 col-sm-3 col-xs-12">Email</label>
                           <div class="col-md-9 col-sm-9 col-xs-12">
                               <input type="text" class="form-control" name="email_upt" value="<?php echo empty($detail['email_upt']) ? NULL : $detail['email_upt']; ?>" max_length="30">
                           </div>
                        </div>
                        <div class="form-group">
