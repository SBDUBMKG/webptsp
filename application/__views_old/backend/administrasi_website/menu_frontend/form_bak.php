            ...
            <div class="box box-info">
                ...
                <form class="form-horizontal" method="post">
                    <div class="box-body">
                      ...
                      <div class="form-group">
                         ...
                         <div class="col-md-9 col-sm-9 col-xs-12">
                          <select class="form-control cmb_select2" id="id_kategori_menu" name="id_kategori_menu">
                              ...
                              <?php
                              $list_kategori = $this->global_model->get_list('tbl_kategori_menu_frontend');
                      ...
                      <div class="form-group">
                         <label class="control-label col-md-3 col-sm-3 col-xs-12">Menu Ind<span class="required">*</span></label>
                         <div class="col-md-9 col-sm-9 col-xs-12">
                      ...
                      <div class="form-group">
                         ...
                         <div class="col-md-9 col-sm-9 col-xs-12">
                          <select class="form-control cmb_select2" id="tipe_menu" name="tipe_menu">
                              ...
                              <option value="2" <?php echo !empty($detail['link_file']) ? NULL : 'selected' ?>>Halaman</option>
                          </select>
                         </div>
                      </div>
                      <div class="form-group box_cname">
                         <label class="control-label col-md-3 col-sm-3 col-xs-12">Cname <span class="required">*</span></label>
                         <div class="col-md-9 col-sm-9 col-xs-12">
                      ...
                      <div class="form-group">
                         <label class="control-label col-md-3 col-sm-3 col-xs-12">Urutan <span class="required">*</span></label>
                         <div class="col-md-9 col-sm-9 col-xs-12">
