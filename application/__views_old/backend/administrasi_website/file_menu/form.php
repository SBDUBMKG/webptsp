                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-9 col-sm-9 col-xs-12">
                               <input type="text" class="form-control" name="nama_file" value="<?php echo empty($detail['nama_file']) ? NULL : $detail['nama_file']; ?>" max_length="255">
                           </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Lampiran</label>
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <input type="file" class="form-control" name="lampiran" value="<?php echo empty($detail['lampiran']) ? NULL : $detail['lampiran']; ?>" <?php echo !empty($detail['lampiran']) ? NULL : 'required' ?>>
                            </div>
                        </div>
                    </div>
                    <!-- /.box-body -->
