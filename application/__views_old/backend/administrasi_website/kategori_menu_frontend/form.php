                ...
                <form class="form-horizontal" method="post">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12">Kategori Menu Ind <span class="required">*</span></label>
...
<!-- line 50 : mengubah kalimat "Uri" menjadi "Alamat Url". Perubahan dilakukan oleh : Nurhayati Rahayu (14/10/2019) -->