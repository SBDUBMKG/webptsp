                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-9 col-sm-9 col-xs-12">
                            <textarea class="input-block-level" id="program_kerja" name="program_kerja">
                              <?php echo empty($detail['program_kerja']) ? NULL : $detail['program_kerja']; ?>
                            </textarea>
                           </div>
                        </div>
                        <div class="form-group">
                           ...
                           <div class="col-md-9 col-sm-9 col-xs-12">
                            <textarea class="input-block-level" id="program_kerja_en" name="program_kerja_en">
                              <?php echo empty($detail['program_kerja_en']) ? NULL : $detail['program_kerja_en']; ?>
                            </textarea>
                           </div>
                        </div>
                    </div>
