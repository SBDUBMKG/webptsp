                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-9 col-sm-9 col-xs-12">
                              ...
                              if(!empty($detail['id_kegiatan'])){
                                $list_foto = $this->global_model->get_list_array('r_galeri_foto','id_kegiatan = '.$detail['id_kegiatan']);
                                if(!empty($list_foto)){
                                        ...
                                        <div class="box box-success box-solid">
                                          <div class="box-header with-border">
                                            ...
                                            <div class="box-tools pull-right">
                                              <?php 
                                                $url = 'upload/kegiatan/'.$detail['judul'].'/'.$value['nama'];
                                                $_SESSION['url'] = $url;
                                              ?>
                                          ...
                                          <div class="box-body">
                                            <img width="210px" src="<?php echo base_url().'upload/kegiatan/'.$value['nama']; ?>" alt="<?php echo $value['nama'];?>" >
                                          </div>
                                        </div>
                                      </div>
                                  <?php 
                                          ...
                                          <div class="box-header with-border">
                                            ...
                                            <div class="box-tools pull-right">
                                              <?php 
                                                ...
                                                $_SESSION['url'] = $url;
                                              ?>
                                              <a href="<?php echo base_url().'backend/manajemen_frontend/kegiatan/default_foto/'.$value['id_fotokegiatan'].'/'.$detail['id_kegiatan']?>">
                                                <i class="fa fa-check" title="jadikan default"></i>
                                              </a>
                                              <a href="<?php echo base_url().'backend/manajemen_frontend/kegiatan/delete_foto/'.$value['id_fotokegiatan'].'/'.$detail['id_kegiatan']?>" OnClick="return confirm('Yakin hapus foto ini?');">
                                                <i class="fa fa-trash" title="hapus foto"></i>
                                              </a>
                                            </div>
                                          </div>
