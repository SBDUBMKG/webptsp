            ...
            <div class="box box-info">
                ...
                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                           <label class="control-label col-md-3 col-sm-3 col-xs-3">Sampul</label>
                           <div class="col-md-3 col-sm-3 col-xs-3">
                               <input type="file" class="form-control" name="sampul" value="<?php echo empty($detail['sampul']) ? NULL : $detail['sampul']; ?>">
                           </div>
                           <div class="col-md-4 col-sm-4 col-xs-4">
                               <small class="label bg-yellow">*Ukuran file maksimal 30MB </small>&nbsp;<small class="label bg-yellow">Ukuran ideal : 240 x 300 (pixel)</small>
                           </div>
                        </div>
                        <div class="form-group">
