            ...
            <div class="box box-info">
                ...
                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-3"> Diterima ? </label>
                            <div class="col-md-1 col-sm-1 col-xs-1">
                                <input name="status" type="checkbox" value="1" <?php echo $checked = !empty($detail['status'])? 'checked' : NULL ?>/>
                            </div>
                        </div>
                    </div>
                    <!-- /.box-body -->
