                ...
                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                      ...
                      <div class="form-group">
                         ...
                         <div class="col-md-9 col-sm-9 col-xs-12">
                             <input type="text" class="form-control" name="layanan" value="<?php echo empty($detail['layanan']) ? NULL : $detail['layanan']; ?>" max_length="255">
                         </div>
                      </div>
                      <div class="form-group">
                         <label class="control-label col-md-3 col-sm-3 col-xs-12">Layanan En</label>
                         <div class="col-md-9 col-sm-9 col-xs-12">
                             <input type="text" class="form-control" name="layanan_en" value="<?php echo empty($detail['layanan_en']) ? NULL : $detail['layanan_en']; ?>" max_length="255">
                         </div>
                      </div>
                      <div class="form-group">
