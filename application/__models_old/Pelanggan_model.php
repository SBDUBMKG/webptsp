...
class Pelanggan_model extends CI_Model
{
    ...
    public function show_datatable($column_datatable, $iDisplayStart,$iDisplayLength,$order,$sSearch){
        ...
        */
        ...
        $this->db->where($where);
        // Select Data
        $this->db->select('id_pelanggan, no_pelanggan, nama_pelanggan, alamat, instansi, email, histori_transaksi, status');
        ...
        foreach($rResult->result_array() as $aRow)
        {
            ...
            $row[] = $aRow['no_pelanggan'];
                $row[] = $aRow['nama_pelanggan'];
                $row[] = $aRow['alamat'];
                $row[] = $aRow['instansi'];
                $row[] = $aRow['email'];
                $row[] = $aRow['histori_transaksi'];
                $row[] = $aRow['status'];
