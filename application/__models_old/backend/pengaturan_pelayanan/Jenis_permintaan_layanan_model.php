...
class Jenis_permintaan_layanan_model extends CI_Model
{
    var $table      = 'm_jenis_permintaan_layanan';
    var $pk_name    = 'id_jenis_permintaan_layanan';
    var $module     = '';
        ...
        */
        ...
        if(isset($sSearch) && !empty($sSearch['value']))
        {
            ...
            for($i=0; $i<count($aColumns); $i++)
            {
                ...
                {
                    if ( $aColumns[$i] == 'jenis_permintaan_layanan' )
        ...
        $this->db->where($where);
        // Select Data
        $this->db->select('id_jenis_permintaan_layanan, jenis_layanan, jenis_permintaan_layanan, m_jenis_permintaan_layanan.keterangan, m_jenis_permintaan_layanan.aktivasi');
