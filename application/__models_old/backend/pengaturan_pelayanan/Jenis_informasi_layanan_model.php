...
class Jenis_informasi_layanan_model extends CI_Model
{
    var $table      = 'm_jenis_informasi_layanan';
    var $pk_name    = 'id_jenis_informasi_layanan';
    var $module     = '';
        ...
        */
        ...
        if(isset($sSearch) && !empty($sSearch['value']))
        {
            ...
            for($i=0; $i<count($aColumns); $i++)
            {
                ...
                {
                    if ( $aColumns[$i] == 'jenis_informasi_layanan' )
        ...
        $this->db->where($where);
        // Select Data
        $this->db->select('jenis_layanan, id_jenis_informasi_layanan, jenis_permintaan_layanan, jenis_unsur_layanan, jenis_informasi_layanan, m_jenis_informasi_layanan.keterangan, m_jenis_informasi_layanan.aktivasi');
