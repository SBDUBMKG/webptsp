...
class Informasi_hba_model extends CI_Model
{
    var $table      = 'tbl_informasi_hba';
    var $pk_name    = 'id_informasi_hba';
    var $module     = '';
    ...
    public function show_datatable($column_datatable, $iDisplayStart,$iDisplayLength,$order,$sSearch){
        ...
        */
        ...
        $this->db->where($where);
        // Select Data
        $this->db->select('id_informasi_hba, judul, judul_en, tanggal, lampiran');
        ...
        foreach($rResult->result_array() as $aRow)
        {
            ...
            $row[] = $aRow['judul_en'];
            $row[] = $aRow['tanggal'];
            $row[] = '<a href="'.base_url().'upload/ebook/'.$aRow['lampiran'].'" target="_blank"><i class="fa fa-download"></i> Lihat File</a>';
