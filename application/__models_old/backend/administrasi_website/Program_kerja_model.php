...
{
    var $table      = 'tbl_visimisi_tupoksi';
    var $pk_name    = 'id';
    var $module     = '';
    ...
    public function show_datatable($column_datatable, $iDisplayStart,$iDisplayLength,$order,$sSearch){
        ...
        */
        ...
        $this->db->where($where);
        // Select Data
        $this->db->select('id, value, value_en');
        ...
        foreach($rResult->result_array() as $aRow)
        {
            ...
            $row[] = '<a href="'.base_url().'upload/program_kerja/'.$aRow['value'].'" target="_blank"><i class="fa fa-download"></i> Lihat</a>';
            $row[] = '<a href="'.base_url().'upload/program_kerja/'.$aRow['value_en'].'" target="_blank"><i class="fa fa-download"></i> Lihat</a>';
