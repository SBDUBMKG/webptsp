...
class M_jenis_tautan_model extends CI_Model
{
    var $table      = 'm_jenis_tautan';
    var $pk_name    = 'id_jenis_tautan';
    var $module     = '';
    ...
    public function show_datatable($column_datatable, $iDisplayStart,$iDisplayLength,$order,$sSearch){
        ...
        */
        ...
        $this->db->where($where);
        // Select Data
        $this->db->select('id_jenis_tautan, jenis_tautan');
