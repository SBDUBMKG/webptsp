...
class Kecamatan_model extends CI_Model {
    ...
    public function show_datatable($column_datatable, $iDisplayStart,$iDisplayLength,$order,$sSearch) {
        ...
        */
        ...
        $this->db->where($where);
        // Select Data
        $this->db->select('id_kecamatan, kecamatan, kabkot, provinsi');
        $this->db->join('m_kabkot', 'm_kecamatan.id_kabkot = m_kabkot.id_kabkot','LEFT');
        $this->db->join('m_provinsi', 'm_kabkot.id_provinsi = m_provinsi.id_provinsi','LEFT');
