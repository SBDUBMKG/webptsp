...
class Informasi_mkg_model extends CI_Model {
  ...
  public function show_datatable($column_datatable, $iDisplayStart, $iDisplayLength, $order, $sSearch) {
    ...
    */
    ...
    $where = " 1 = 1";
    if($id_role == 4) {
      $where .= " AND tbl_permohonan.status = 4 ";
    }
    if($id_role == 7) {
    ...
    foreach($rResult->result_array() as $aRow)
    {
      ...
      if( $id_role == 3 ) { // ADMIN
        if( $aRow['status'] == 0 ) {
          ...
          // $aksi = '<a href="'.site_url('backend/permohonan_layanan/permohonan_layanan/verifikasi_pembayaran/'.$aRow[$this->pk_name]).'"><i class="fa fa-fw fa-check-circle-o"></i> Verifikasi</a>';
          // $aksi = '';
          ...
          // $aksi = '<a href="'.site_url('backend/permohonan_layanan/permohonan_layanan/verifikasi/'.$aRow[$this->pk_name]).'"><i class="fa fa-fw fa-check-circle-o"></i> Konfirmasi</a>';
          // $aksi = '';
          ...
          $aksi = '<a href="'.site_url('backend/permohonan_layanan/permohonan_layanan/verifikasi_akhir/'.$aRow[$this->pk_name]).'"><i class="fa fa-fw fa-check-square"></i> Verifikasi</a>';
        ...
        if( $aRow['status'] == 0 ) {
          ...
          $aksi = '<a class="btn btn-xs btn-primary" href="'.site_url('backend/permohonan_layanan/permohonan_layanan/proses/'.$aRow[$this->pk_name]).'"><i class="fa fa-pencil-square"></i> Lengkapi Data</a>';
        } else if( $aRow['status'] == 2 ) {
          ...
          $aksi = '<a class="btn btn-xs btn-success" href="'.site_url('backend/permohonan_layanan/permohonan_layanan/invoice/'.$aRow[$this->pk_name]).'" target="_blank"><i class="fa fa-file-o"></i> Invoice</a> <a class="btn btn-xs btn-warning" href="'.site_url('backend/permohonan_layanan/permohonan_layanan/upload/'.$aRow[$this->pk_name]).'"><i class="fa fa-upload"></i> Upload</a>';
        } else if( $aRow['status'] == 4 ) {
          ...
          $stts = '<font color=green><i class="fa fa-fw fa-check"></i> Transaksi Sukses</font>';
          $aksi = '<a class="btn btn-xs btn-success" href="'.site_url('upload/dokumen/'.$aRow['pengantar']).'"><i class="fa fa-fw fa-print"></i> Dok. Pengantar</a> <a class="btn btn-xs btn-danger" href="'.site_url('backend/permohonan_layanan/permohonan_layanan/review/'.$aRow[$this->pk_name]).'"><i class="fa fa-fw fa-pencil-square"></i> Review Layanan</a>';
        } else if( $aRow['status'] == 8 ) {
