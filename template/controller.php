 ...
 */
class _ControllerName_ extends MY_Controller {
    var $page_title = '_page_title_';
    var $column_datatable = array(_column_datatable_);
    var $folder         = '';
    var $module         = '';
    ...
    function __construct(){
        ...
        $this->load->model($this->folder.'/'.'_ControllerName__model', 'app_model');
...
"processing": true,
        ...
        $this->template->write_view('content', $this->folder.'/_ControllerName_/datatable', $data, true);
    ...
    function add() {
        ...
        $this->template->write_view('content', $this->folder.'/_ControllerName_/form', $data, true);
        $this->template->render();
    }
    function edit($id = 0) {
        $this->load->model('global_model');
